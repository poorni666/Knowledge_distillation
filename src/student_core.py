    ...
    for epoch in range(epochs):
        ...
        for inputs, labels in dataloader:
            if fixed_T is not None and fixed_alpha is not None:
                ...
                # Use exponential decay with a floor value for T and alph
                T = exp_decay_with_floor(5.0, 3.0, 0.95, epoch)    # T won't go below 3.0
                alpha = exp_decay_with_floor(0.8, 0.5, 0.95, epoch) # alpha won't go below 0.5
            """
                Alternatively i experimented with linear decay for T and alpha.
                These trained weights are saved in drafts.
